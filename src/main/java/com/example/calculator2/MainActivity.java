...
import com.example.calculator2.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // defining the edit text 2 to e2
        e2 = (EditText) findViewById(R.id.num2);
        Button b=(Button)findViewById(R.id.E);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                calculator c1=new calculator();
                String s=((EditText)findViewById(R.id.Expression)).getText().toString();
                TextView c= (TextView) findViewById(R.id.result);
                c.setText(String.valueOf(c1.evaluate(s)));
            }
        });
    }
